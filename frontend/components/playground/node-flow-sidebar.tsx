...
import { User, Check, X, Loader2, Pause, Clock } from "lucide-react"
                  ...
                  return (
                    <div key={nodeId} className="relative">
                      ...
                      <button
                        ...
                        className={cn(
                          "w-full text-left rounded-lg border px-3 py-2 transition-all relative",
                          style.bg,
                          style.border,
                          isSelected && "ring-2 ring-primary ring-offset-1 ring-offset-background scale-[1.02]",
                          isCurrent && nodeData.status === "running" && "animate-breathe"
                        )}
                      >
                        {/* Header */}
